...
# --- §9 pinned constants -------------------------------------------------------
# Derived over the whole stored corpus (75 telemetried sessions, 1,518 laps, 24,963
...
TRAIL_CORNER_ROWS = 24_963
#: R1 -- `brake_point_m IS NULL`. A positive report, not a gap.
TRAIL_FLAT_ROWS = 4_642
TRAIL_BRAKED_ROWS = 20_321
